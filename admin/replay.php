...
if(isset($_GET['id'])){
    $id=$_GET['id'];
    $res=mysqli_query($con, "SELECT * FROM `contact_us` where co_id=".$id);
...
<head>
    ...
    <title>Adrees Academy Admin-Panel</title>
                            ...
                            <div class="mail-list-container">
                                <form class="mail-compose">
                                    <div class="form-group col-12">
                                        <input class="form-control" type="email" value="<?php echo $row['co_email']?>" placeholder="To">
                                    </div>
                                   
                                    <div class="form-group col-12">
                                        <input class="form-control" type="text" value="<?php echo $row['co_subject']?>" placeholder="Subject">
                                    </div>
                                    <div class="form-group col-12">
