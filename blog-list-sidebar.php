...
<body id="bg">
	<div class="page-wraper">
		...
		<div class="page-content bg-white">
			<!-- inner page banner -->
			<div class="page-banner ovbl-dark" style="background-image:url(Adrees/s41.jpg);">
				<div class="container">
							...
							<div class="col-lg-8">
								<div class="blog-post blog-md clearfix">
									<div class="ttr-post-media">
										<a href="blog-details.php?src=s27.jpg"><img src="Adrees/s27.jpg" alt=""></a>
									</div>
									<div class="ttr-post-info">
										<ul class="media-post">
											<li><a href="blog-details.php?src=s27.jpg"><i class="fa fa-calendar"></i>Jan 12 2019</a></li>
											<li><a href="blog-details.php?src=s27.jpg"><i class="fa fa-user"></i>By William</a></li>
										</ul>
										<h5 class="post-title"><a href="blog-details.php?src=s24.jpg">This Story Behind Education Will Haunt You Forever.</a></h5>
										<p>Knowing that, you’ve optimised your pages countless amount of times, written tons.</p>
										<div class="post-extra">
											<a href="blog-details.php?src=s24.jpg" class="btn-link">READ MORE</a>
											<a href="blog-details.php#top-to-comment" class="comments-bx"><i class="fa fa-comments-o"></i>05 Comment</a>
										</div>
									</div>
								</div>
								<div class="blog-post blog-md clearfix">
									<div class="ttr-post-media">
										<a href="#"><img src="Adrees/s25.jpg" alt=""></a>
									</div>
									<div class="ttr-post-info">
										<ul class="media-post">
										...
										<div class="post-extra">
											...
											<a href="blog-details.php#top-to-comment" class="comments-bx"><i class="fa fa-comments-o"></i>12 Comment</a>
										</div>
									</div>
								</div>
								<div class="blog-post blog-md clearfix">
									<div class="ttr-post-media">
										<a href="#"><img src="Adrees/s3.jpg" alt=""></a>
									</div>
									<div class="ttr-post-info">
										<ul class="media-post">
										...
										<div class="post-extra">
											<a href="blog-details.php" class="btn-link">READ MORE</a>
											<a href="blog-details.php#top-to-comment" class="comments-bx"><i class="fa fa-comments-o"></i>20 Comment</a>
										</div>
									</div>
								</div>
								<div class="blog-post blog-md clearfix">
									<div class="ttr-post-media">
										<a href="#"><img src="Adrees/s1.jpg" alt=""></a>
									</div>
									<div class="ttr-post-info">
										<ul class="media-post">
										...
										<div class="post-extra">
											<a href="blog-details.php" class="btn-link">READ MORE</a>
											<a href="blog-details.php#top-to-comment" class="comments-bx"><i class="fa fa-comments-o"></i>28 Comment</a>
										</div>
									</div>
								</div>
								<div class="blog-post blog-md clearfix">
									<div class="ttr-post-media">
										<a href="#"><img src="Adrees/s2.jpg" alt=""></a>
									</div>
									<div class="ttr-post-info">
										<ul class="media-post">
										...
										<div class="post-extra">
											<a href="blog-details.php" class="btn-link">READ MORE</a>
											<a href="blog-details.php#top-to-comment" class="comments-bx"><i class="fa fa-comments-o"></i>26 Comment</a>
										</div>
									</div>
								</div>
								<div class="blog-post blog-md clearfix">
									...
									<div class="ttr-post-info">
										...
										<div class="post-extra">
											<a href="blog-details.php" class="btn-link">READ MORE</a>
											<a href="blog-details.php#top-to-comment" class="comments-bx"><i class="fa fa-comments-o"></i>15 Comment</a>
										</div>
									</div>
								</div>
								<div class="blog-post blog-md clearfix">
							...
							<div class="col-lg-4 sticky-top">
								<aside class="side-bar sticky-top">
									...
									<div class="widget recent-posts-entry">
										...
										<div class="widget-post-bx">
											<div class="widget-post clearfix">
												<div class="ttr-post-media"> <img src="Adrees/s36.jpg" width="200" height="143" alt=""> </div>
												<div class="ttr-post-info">
											...
											<div class="widget-post clearfix">
												<div class="ttr-post-media"> <img src="Adrees/s37.jpg" width="200" height="160" alt=""> </div>
												<div class="ttr-post-info">
													<div class="ttr-post-header">
											...
											<div class="widget-post clearfix">
												<div class="ttr-post-media"> <img src="Adrees/s35.jpg" width="200" height="160" alt=""> </div>
												<div class="ttr-post-info">
													<div class="ttr-post-header">
									...
									<div class="widget widget_gallery gallery-grid-4">
										...
										<ul>
											<li>
												<div><a href="#"><img src="Adrees/s28.jpg" alt=""></a></div>
											</li>
											<li>
												<div><a href="#"><img src="Adrees/s29.jpg" alt=""></a></div>
											</li>
											<li>
												<div><a href="#"><img src="Adrees/s30.jpg" alt=""></a></div>
											</li>
											<li>
												<div><a href="#"><img src="Adrees/s70.jpg" alt=""></a></div>
											</li>
											<li>
												<div><a href="#"><img src="Adrees/s28.jpg" alt=""></a></div>
											</li>
