...
<body id="bg">
	<div class="page-wraper">
		...
		<div class="page-content bg-white">
			<!-- inner page banner -->
			<div class="page-banner ovbl-dark" style="background-image:url(Adrees/s53.jpg);">
				<div class="container">
			...
			<div class="content-block">
				<!-- About Us -->
				<?php $res1 = mysqli_query($con, 'SELECT course_categories.*,course_info.* FROM `course_info` INNER JOIN course_categories on course_info.course_fk=course_categories.course_cat_id WHERE course_info.course_fk=3 or course_info.course_id=' . $id);
							...
							<div class="col-lg-3 col-md-4 col-sm-12 m-b30">
								<div class="course-detail-bx">
									<div class="course-price">
										...
										<del><?php echo (int)($row['course_price']) . " RS"; ?></del>
										<h4 class="price"><?php echo (int)($row['course_price'] - 20.3) . " RS"; ?></h4>
									</div>
									<div class="course-buy-now text-center">
										<a href="membership.php" class="btn radius-xl text-uppercase">Buy Now This Courses</a>
									</div>
										...
										<a href="profile.php">
											<div class="teacher-info">
												...
												<div class="teacher-name">
													...
													<h5> Sir Adrees</h5>
													<span><?php echo $row['course_cat_name']; ?> Teacher</span>
												</div>
											</div>
										</a>
									</div>
									<div class="cours-more-info">
										...
										<div class="price categories">
											...
											<h5 class="text-primary"><?php echo $row['course_cat_name']; ?></h5>
										</div>
									</div>
							...
							<div class="col-lg-9 col-md-8 col-sm-12">
								<div class="courses-post">
									<div class="ttr-post-media media-effect">
										<a href="#"><img src="Adrees/Courses/<?php echo $row['course_img']; ?>" alt=""></a>
									</div>
									<div class="ttr-post-info">
										...
										<div class="ttr-post-text">
											<p><?php echo substr($row['course_detail'], 0, 500) . "."; ?></p>
										</div>
									</div>
								</div>
