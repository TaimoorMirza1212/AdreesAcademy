...
<head>
    <!-- FAVICONS ICON ============================================= -->
    <link rel="icon" type="img/jpg/png" href="./partials/favicon.png">
</head>
    ...
    <div class="page-wraper">
        ...
        <div class="page-content bg-white">
                    ...
                    <div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
                        <ul>
                            ...
                            <li data-index="rs-100" data-transition="parallaxvertical" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="error-404.html" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="A STUDY ON HAPPINESS" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="Science says that Women are generally happier">
                                <!-- MAIN IMAGE -->
                                <img src="Adrees/s2.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina />
                                ...
                                <div class="tp-caption Newspaper-Subtitle   tp-resizeme" id="slide-100-layer-4" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['top','top','top','top']" data-voffset="['320','320','320','290']" data-width="['800','800','700','420']" data-height="['100','100','100','120']" data-whitespace="unset" data-type="text" data-responsive_offset="on" data-frames='[{"from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","speed":1500,"to":"o:1;","delay":1000,"ease":"Power3.easeInOut"},{"delay":"wait","speed":1000,"to":"auto:auto;","mask":"x:0;y:0;s:inherit;e:inherit;","ease":"Power3.easeInOut"}]' data-textAlign="['center','center','center','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 7; text-transform:capitalize; white-space: unset; color:#fff; font-family:rubik; font-size:18px; line-height:28px; font-weight:400;">
                                    Come back soon, Our Website is still under development.
                                </div>
                                <!-- LAYER NR. 4 -->
                                <a href="about-1.php">
                            ...
                            <li data-index="rs-200" data-transition="parallaxvertical" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="assets/images/slider/slide1.jpg" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="A STUDY ON HAPPINESS" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="Science says that Women are generally happier">
                                <!-- MAIN IMAGE -->
                                <img src="Adrees/s1.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina />
            ...
            <div class="content-block">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="service-bx">
                                    <div class="action-box">
                                        <img src="Adrees/s5.jpg" alt="">
                                    </div>
                                    <div class="info-bx text-center">
                                        <div class="feature-box-sm radius bg-white">
                                            <i class="fa fa-bank text-primary"></i>
                                        </div>
                                        <h4><a href="#">Business Markeeting</a></h4>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="service-bx m-b0">
                                    <div class="action-box">
                                        <img src="Adrees/s10.jpg" alt="">
                                    </div>
                                    <div class="info-bx text-center">
                                        <div class="feature-box-sm radius bg-white">
                                            <i class="fa fa-file-text-o text-primary"></i>
                                        </div>
                                        <h4><a href="#">Learning Offers</a></h4>
                                        <a href="#" class="btn radius-xl">View More</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                                ...
                                $res1 = mysqli_query($con, 'SELECT course_categories.*,course_info.* FROM `course_info` INNER JOIN         course_categories on course_info.course_fk=course_categories.course_cat_id WHERE course_info.course_fk=5  ');
                                $row = mysqli_fetch_assoc($res1) ?>
                                <div class="item">
                                    <div class="cours-bx">
                                        <div class="action-box">
                                            <img src="Adrees/Courses/<?php echo $row['course_img']; ?>" alt="">
                                            <a href="courses-details.php?id=<?php echo $row['course_id']; ?>" class="btn">Read More</a>
                                        </div>
                                        <div class="info-bx text-center">
                                            <h5><a href="courses-details.php?id=<?php echo $row['course_id']; ?>"><?php echo $row['course_name']; ?></a></h5>
                                            <span><?php echo $row['course_cat_name']; ?></a></span>
                                        </div>
                                        <div class="cours-more-info">
                                            ...
                                            <div class="price">
                                                <del><?php echo $row['course_price'] . " <span style='font-size:11px'>RS</span>"; ?></a></del>
                                                <h5><?php echo $row['course_price'] - 20.3 . " <span style='font-size:1.1rem'>RS</span>"; ?></a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <?php
                                $res2 = mysqli_query($con, 'SELECT course_categories.*,course_info.* FROM `course_info` INNER JOIN course_categories on course_info.course_fk=course_categories.course_cat_id WHERE course_info.course_fk=1  ');
                                ...
                                $res3 = mysqli_query($con, 'SELECT course_categories.*,course_info.* FROM `course_info` INNER JOIN course_categories on course_info.course_fk=course_categories.course_cat_id WHERE course_info.course_fk=4 limit 1 ');
                                ...
                                <?php
                                $res4 = mysqli_query($con, 'SELECT course_categories.*,course_info.* FROM `course_info` INNER JOIN course_categories on course_info.course_fk=course_categories.course_cat_id WHERE course_info.course_fk=3  ');
                ...
                <!-- Form -->
                <div class="section-area section-sp1 ovpr-dark bg-fix online-cours" style="background-image:url(Adrees/s11.jpg);">
                    <div class="container">
                        <div class="row">
                ...
                <!-- Testimonials -->
                <div class="section-area section-sp2 bg-fix ovbl-dark" style="background-image:url(Adrees/s33.jpg);">
                    <div class="container">
                        <div class="row">
                        ...
                        <div class="item">
                                <div class="testimonial-bx">
                                    <div class="testimonial-thumb">
                                        <img src="Adrees/testi3.jpeg" alt="" >
                                    </div>
                                    <div class="testimonial-info">
                                        <h5 class="name">Taimoor Mirza</h5>
                                        <p>-Web Developer</p>
                                    </div>
                        ...
                        <div class="item">
                                <div class="testimonial-bx">
                                    <div class="testimonial-thumb">
                                        <img src="Adrees/testi2.jpeg" alt="" >
                                    </div>
                                    <div class="testimonial-info">
                                        <h5 class="name">Qayyum</h5>
                                        <p>-Web Developer</p>
                                    </div>
                                    <div class="testimonial-content">
                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type...</p>
                            ...
                            <div class="item">
                                <div class="testimonial-bx">
                                    <div class="testimonial-thumb">
                                        <img src="Adrees/testi1.jpeg" alt="" >
                                    </div>
                                    <div class="testimonial-info">
                                        <h5 class="name">Arslan Ahmad</h5>
                                        <p>-Web Developer</p>
                                    </div>
                                    <div class="testimonial-content">
                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type...</p>
